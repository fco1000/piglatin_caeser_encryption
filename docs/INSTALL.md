...
- Install Go: download and run the Windows MSI from the official Go site, then confirm in PowerShell:

```powershell
go version
```

- Install Python: use the Windows installer from python.org or the Microsoft Store. Create and activate a virtual environment:
...
- Install test and helper packages (optional):
